---
title: AI-Powered Skill Enhancement
description: Enhance your SKILL.md files with AI using Claude Code Max (free) or Anthropic API - adds code examples, quick references, and best practices
section: features
order: 4
---
...
- [Enhancement Modes](/docs/features/enhancement-modes) - Deep dive into all enhancement modes
