---
title: Bulletproof Quick Start Guide
description: Complete beginner's guide to installing Skill Seekers from scratch - includes Python, Git, and everything you need
...
**See:** [MCP Setup Guide](/docs/guides/mcp-setup) for full MCP setup
...
1. **Check our detailed troubleshooting guide:** [Troubleshooting Guide](/docs/guides/troubleshooting)
...
- [Quick Start Guide](/docs/getting-started/quickstart) - Faster workflow for experienced users
- [CLI Reference](/docs/cli/overview) - Complete command documentation
- [MCP Setup Guide](/docs/guides/mcp-setup) - Integrate with Claude Code
- [Features Overview](/docs/features/three-stream-architecture) - Advanced capabilities
