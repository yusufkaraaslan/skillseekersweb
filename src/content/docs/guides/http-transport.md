---
title: HTTP Transport Guide
description: Learn about HTTP transport mode for the Skill Seeker MCP server - supports web clients, remote access, and multiple simultaneous connections
section: guides
order: 7
---
...
The Skill Seeker MCP server supports both **stdio** (default) and **HTTP** transports, giving you flexibility in how you connect Claude Code or other MCP clients.
...
- [Multi-Agent Setup](/docs/guides/multi-agent-setup)
